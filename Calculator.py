# CALCULATOR 
# PERFORM OPERATIONS :- 1.ADDITION  2.SUBTRACTION  3.MULTIPLICATION  4.DIVISION  5.MODULUS
# 1.NATURAL LOG  2.TRIGNOMETRIC CALCULATIONS  3.EXPONENTIAL CALCULATIONS

from tkinter import *
import math as m
root =Tk()
# GIVING TITLE AS simple calculator
...
ac = Button(root, text="C", padx=29, pady=10, relief=RAISED, bg="Red", fg="White",command=lambda:clear())
bksp = Button(root, text="DEL", padx=24, pady=10, relief=RAISED, bg="Red", fg="White",command=lambda: bksps())
...
seven = Button(root, text="7", padx=30, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("7"))
eight = Button(root, text="8", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("8"))
nine = Button(root, text="9", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("9"))
...
four = Button(root, text="4", padx=30, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("4"))
five = Button(root, text="5", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("5"))
six = Button(root, text="6", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("6"))
...
one = Button(root, text="1", padx=30, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("1"))
two = Button(root, text="2", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("2"))
three = Button(root, text="3", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("3"))
...
zero = Button(root, text="0", padx=29, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("0"))
equal = Button(root, text="=", padx=29, pady=10, relief=RAISED, bg="Red", fg="Black",command=lambda: evaluate())
